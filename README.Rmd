...
Students can configure Posit Assistant in RStudio to act as an interactive AI Assistant connected to the free CUNY AI Lab (CAIL) service. See the [Posit Assistant Setup Guide](POSIT_ASSISTANT_SETUP.md) for step-by-step instructions. I will provide API keys.

The course context file [`AGENTS.md`](AGENTS.md) is included in this repository and will automatically load whenever you open this project in RStudio.
