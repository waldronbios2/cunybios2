...
To add a new git submodule to this repo, invoke the following from within the local waldronbios2 clone (example for session10):
```
...
Then update the file `youtubeURLs.csv` with links to lecture and lab recordings.
