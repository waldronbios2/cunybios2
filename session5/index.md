...
2.  Fit Poisson and Negative Binomial models as in the lecture, with and
    without zero inflation.

3.  Use chi-square nested deviance tests to assess which model seems to
    fit best.

4.  Create residual deviance plots using the functions defined in the
    lecture.
